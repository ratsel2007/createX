...
if(document.querySelector('.slider-arrivals')) {
	new Swiper('.slider-arrivals__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
...
if(document.querySelector('.slider-trend')) {
	new Swiper('.slider-trend__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.slider-trand__arrows .slider__arrow_next',
			prevEl: '.slider-trand__arrows .slider__arrow_prev',
		},
		breakpoints: {
			320: {
				slidesPerView: 1.3,
...
if(document.querySelector('.slider-sales')) {
	new Swiper('.slider-sales__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.slider-sales__arrows .slider__arrow_next',
			prevEl: '.slider-sales__arrows .slider__arrow_prev',
		},
		breakpoints: {
			320: {
				slidesPerView: 1.3,
...
const catalogNav = document.querySelectorAll('.catalog__item');
const body = document.querySelector('body');

for (let index = 0; index < catalogNav.length; index++) { 
  body.addEventListener('click', (e) => {
    if(!e.target.closest('.catalog')) {
      catalogNav[index].classList.remove("_active");
    }
  })
  catalogNav[index].addEventListener('click', (e) => {
    if(catalogNav[index].classList.contains("_active") && !e.target.closest('.block-catalog')) { 
      catalogNav[index].classList.remove("_active");
    } else {
      for (let index = 0; index < catalogNav.length; index++) { 
        catalogNav[index].classList.remove("_active");
      }
      catalogNav[index].classList.add("_active"); 
    }    
  }) 
}


let checkboxesSubscribe = document.querySelectorAll('.form-subscribe input[type="checkbox"]');

for (let index = 0; index < checkboxesSubscribe.length; index++) {
	const checkboxSubscribe = checkboxesSubscribe[index];
	checkboxSubscribe.addEventListener("change", function (e) {
		checkboxSubscribe.classList.toggle('_active');
	});
}

document.querySelector('.form-subscribe__checkbox_agree').addEventListener('change', () => {
  console.log('222');
  if(document.querySelector('.form-subscribe__checkbox_agree .checkbox__input').classList.contains("_active")) {
    console.log('111');
    document.querySelector('.form-subscribe__btn').disabled = false;
  } else {
    document.querySelector('.form-subscribe__btn').disabled = true;
  }
})
